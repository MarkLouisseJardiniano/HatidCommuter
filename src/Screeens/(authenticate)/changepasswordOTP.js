...
<TouchableOpacity>
    <Text style={{ color: "black", backgroundColor: "powderblue", padding: 10, textAlign: "center", borderRadius: 10,    fontWeight: 'bold',
    fontSize: 18, }} onPress={handleVerifyOtp}>Confirm</Text>
  </TouchableOpacity>
